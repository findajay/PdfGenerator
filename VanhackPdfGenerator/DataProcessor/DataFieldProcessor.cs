...
namespace VanhackPdfGenerator.DataProcessor
{
    public static class DataFieldProcessor
    {
        ...
        {
            ImmigrationFormData DataSet = new ImmigrationFormData();
            ...
            DataSet.Yes_business = "1";
            DataSet.No_business = "0";
            DataSet.Yes_inn = "0";
            DataSet.No_inn = "1";
            DataSet.PrincipalReferalPartner = new BasicDetails
            {
                F_first_name = "Ajay",
                F_mid_name = "",
                F_last_name = "Kumar",
            ...
            DataSet.AlternateReferalPartner = new BasicDetails
            {
